...
const AddProperty = ({ isOpen, onClose }) => {
  ...
  const handleFileUpload = (imageUrl) => {
    ...
    setValue('image', imageUrl); // This is key - update the form value
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 overflow-y-auto">
          <div className="bg-dark text-white p-8 rounded-md shadow-md w-[90%] max-h-[40rem] lg:w-[35rem] mt-6 overflow-y-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <label htmlFor="property_name" className="block">Property Name</label>
                <InputComponent
                  id="property_name"
                  type="text"
              ...
              <div>
                <label htmlFor="property_type" className="block">Property Type</label>
              ...
              <FileUpload onFileUpload={handleFileUpload}/>
                {imageUrl && (
                  <img 
                    src={imageUrl} 
                    alt="Uploaded" 
                    className="mt-6  mx-auto h-[15rem]"
                  />
                )}
