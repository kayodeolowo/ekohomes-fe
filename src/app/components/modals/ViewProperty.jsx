    ...
    <>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 overflow-y-auto scrollbar-hide">
          <div className="bg-dark text-white p-8 rounded-md shadow-md w-[90%] max-h-[40rem] lg:w-[35rem] mt-6 scrollbar-hide overflow-y-auto">
            ...
            {property && (
              <div>
                ...
                <h2 className=" text-3xl mt-4 font-bold">{property.property_name}</h2>
